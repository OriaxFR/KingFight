...
public class ItemCoffre {
    ...
    public ItemCoffre(Material material, int quantite, double chance, String nomCustom, List<String> loreCustom, Map<Enchantment, Integer> enchantements, List<Short> typesPotion) {
    ...
    public ItemCoffre(Material material, int quantite, double chance, String nomCustom, List<String> loreCustom, Map<Enchantment, Integer> enchantements) {
        this(material, quantite, chance, nomCustom, loreCustom, enchantements, null);
    }

    public ItemCoffre(Material material, int quantite, double chance) {
